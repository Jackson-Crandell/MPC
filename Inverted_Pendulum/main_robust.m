%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  MPC-DDP on Inverted Pendulum (Robustness Test) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k = 1:10
    ...
    % Inverted Pendulum Parameters (Nominal)
    g = 9.81;       % gravity 
    ...
    % Inverted Pendulum Parameters (Real)
    sigma = 0.5;
    rand_num = sigma * randn
    dynamics = struct('g', g + g * rand_num,...
                      'b1', b + b * rand_num,...
                      'l1', l + l * rand_num,...
                      'I1', I + I * rand_num);
    display(rand_num)
    ...
    while 1
        ...
        [x] = fnDynamics(x_init,u,Horizon,dt,0,dynamics); % Use real dynamics
        x_init = x(:,2);
